...
| `codec` | HEVC motion/size heuristic, CPU (`libde265`) decode | 500 | 61.6% | 2,716 | 0.87s | 1.11s | 1.40s | 0.16s | 0.29s | 4.50s |
| `codec_nvdec` | Same heuristic, GPU (NVDEC) decode | 500 | 60.6% | 2,716 | 0.86s | 0.09s | 0.37s | 0.16s | 0.28s | **2.44s** |
...
the table at the top) via [`scripts/print_table.py`](scripts/print_table.py):
